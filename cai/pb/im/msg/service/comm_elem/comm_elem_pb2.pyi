...
class MsgElemInfo_servtype2(Message):
    ...
    def HasField(self, field_name: Literal[u"face_bubble_count",b"face_bubble_count",u"hit",b"hit",u"msg_type",b"msg_type",u"poke_flag",b"poke_flag",u"poke_strength",b"poke_strength",u"poke_summary",b"poke_summary",u"poke_type",b"poke_type",u"vaspoke_id",b"vaspoke_id",u"vaspoke_minver",b"vaspoke_minver",u"vaspoke_name",b"vaspoke_name"]) -> bool: ...
    def ClearField(self, field_name: Literal[u"face_bubble_count",b"face_bubble_count",u"hit",b"hit",u"msg_type",b"msg_type",u"poke_flag",b"poke_flag",u"poke_strength",b"poke_strength",u"poke_summary",b"poke_summary",u"poke_type",b"poke_type",u"vaspoke_id",b"vaspoke_id",u"vaspoke_minver",b"vaspoke_minver",u"vaspoke_name",b"vaspoke_name"]) -> None: ...
